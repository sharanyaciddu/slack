...
public class SeleniumScreenRecorder extends ScreenRecorder {
    ...
    public SeleniumScreenRecorder(GraphicsConfiguration cfg, Rectangle captureArea,
    ...
    protected File createMovieFile(Format fileFormat) throws IOException {
        ...
        File file = new File(movieFolder,
                name + "-" + dateFormat.format(new Date()) + "." + Registry.getInstance()
                        .getExtension(fileFormat));
        System.out.println("the actual file is at " + file.getAbsolutePath());
        return file;
    }
}
